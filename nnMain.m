...
% to predict the value of handwritten numbers. Currently(8/23/18) stands at # 2207 out of 2316 on Kaggle with 
% ~81% success rate. fmincg optimization algorithm was written by Carl Edward Rasmussen (c) 1999-2002.
...
options = optimset('GradObj', 'on', 'MaxIter', 10); % 10 iterations with my computer takes ~2 hours so with better specifications (or a better algorithm)
